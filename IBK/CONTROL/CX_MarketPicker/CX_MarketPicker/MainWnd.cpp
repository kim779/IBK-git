...
void CMainWnd::SetsCode(BSTR newVal)
{
	...
	m_slog.Format("!!!!!![cxMarketPicker][MARKET]<SetsCode 시작>[%s][%s]  m_sID=[%s] m_markettype=[%s] m_iPermission=[%d] m_major=[%d] m_sCode=[%s] m_minor = [%d]",
		m_sCtrlName, newVal,m_sID, MarketToString(m_markettype), m_iPermission, m_major, m_sCode, m_minor);
	OutputDebugString(m_slog);
...
void CMainWnd::SetsMarket(BSTR newVal)
{
	...
	m_slog.Format("####[cxMarketPicker][MARKET]<SetsMarket 시작>[%s][%s]  m_sID=[%s] m_markettype=[%s] m_iPermission=[%d] m_major=[%d] m_sCode=[%s] m_minor = [%d]",
		m_sCtrlName, newVal,m_sID, MarketToString(m_markettype), m_iPermission, m_major, m_sCode, m_minor);
	OutputDebugString(m_slog);
