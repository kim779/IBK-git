...
void CintGrid::SortBase(CMapStringToString *pMap /* = nullptr */)
{
	...
	MessageToParent(m_sortColumn, 0, GVNM_ENDSORT);   //SortBase
	Invalidate();
}
// END ADD
...
//					m_ascending = !m_ascending;
				...
				{
					SortTextItems(m_sortColumn, m_ascending);  //test 20230202
					MessageToParent(m_sortColumn, 0, GVNM_ENDSORT);  //test 20230202
				}
