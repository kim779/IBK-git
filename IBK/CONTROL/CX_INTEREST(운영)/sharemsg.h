#ifndef __SHAREINFOMATION001_H__
#define __SHAREINFOMATION001_H__
...
#define	MK_VIEWTYPE			90
#define	MK_CHANGE1FIELD		91
#define MK_RECVDATA2		92	// data를 받았을 때 메시지
#define MK_CHANGEDIFFFIELD	93
#define MK_GETVIEWPAGE		94
#define	MK_ARRANGE			95
#define	MK_GETARRANGE		96
#define MK_SETARRANGE		97
#define MK_SETGROUPINDEX	98
#define MK_SETVIEWTYPE		99
#define MK_RELOADLIST		100
#define MK_SETPAGEVIEW		101
#define	MK_GROUPSAVE2		102
#define MK_CHANGEARRANGE	103
#define MK_CHANGEVIEWTYPE	104
#define MK_VIEWREFRESH		105
#define MK_SETAUTOCHECK		106


// INTERFIELD FILE TYPE
#define MK_FILETYPE			107
#define MK_SETGROUP			108

#define MK_EDITWORK			109
#define MK_SAVEFOROUB		110
#define MK_ISNEWDROP		111
#define MK_RECOVER			112
#define MK_DELETEORGFILE	113
#define MK_NOSELECT			114
#define MK_DUPLICATE		115
#define MK_REMAIN			116
#define MK_ACCOUNT			117
#define MK_CLEAR			118
#define MK_SETEXPECT		119
#define MK_BOUCODE			120
#define MK_GetSearchType	121
#define MK_PTRGROUPCODE     122
#define MK_BOOKMARKPROCESSCHECK 123
...
#define IDC_BT_CHANGEFIELD	1053
#define IDC_BT_PREVVIEW		1054
#define IDC_BT_NEXTVIEW		1055
#define IDC_CB_ARRANGE		1056
#define IDC_CB_VIEWTYPE		1057
#define IDC_CB_PAGEVIEW		1058
...
#define TRKEY_BACKUP		0x19    // 2016.07.12 'b' 백업
#define TRKEY_LASTSET		0x20    // 2016.07.12 'V' 최종상태저장
#define TRKEY_InitGROUPARR  0x21	//관심그룹 조회 화면오픈시 
#define TRKEY_GROUPARR		0x22	//관심그룹 조회 새로고침
#define TRKEY_GROUPCODE		0x23	//관심그룹 조회 새로고침

// default value
#define DEF_ROWH		18
#define DEF_FIELD		"필드 00"
#define DEF_FIELD_CONTENT	_T("필드 00;2024;2033;2027;2204;2029;2030;2031;")
#define DEF_FIELD_CONTENT1	_T("필드 00;2024;2033;2027;")

// file names
#define FILE_CONFIG	"intercfg.ini"
#define FILE_FIELD	"interfield.ini"
#define FILE_SMALLCONFIG	"intercfg3.ini"		// 뉴관심종목에서 새로이 만들어진 관심종목의 전체적인 환경을 저장하는 파일
#define FILE_GROUP	"portfolio.ini"		// 관심종목의 그룹을 저장하는 파일
#define FILE_SUBDATA	"portfolio.i"		// 확장자 뒤에 두자리는 숫자로 저장된다.
#define FILE_SMALLFIELD	"interfield3.ini"	// 필드 저장파일
#define FILE_LARGECONFIG	"intercfg4.ini"
#define FILE_LARGEFIELD	"interfield4.ini"
...
} gridHdr[] = 
{
	...
	{IDS_GH_7853,		0,	GVAT_HIDDEN,	"7853",	GVFM_RIGHT,	GVAT_COMMA,				2},	// 13	거래량
	{IDS_GH_7854,		0,	GVAT_HIDDEN,	"7854",	GVFM_RIGHT,	GVAT_COMMA,				2},	// 13	대비
	{IDS_GH_7855,		0,	GVAT_HIDDEN,	"7855",	GVFM_RIGHT,	GVAT_COMMA,				2},	// 13	등락률
	{-2,				0,	GVAT_HIDDEN,			"1354",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,		2},	//		증거금율
	{-2,				0,	GVAT_HIDDEN,			"1355",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,		2},	//		신용보증금증거금율

	{-1,			20,	GVAT_TEXT,			"9###", GVFM_CENTER,	GVAT_TOOLTIP|GVAT_COMMA|GVAT_CONDITIONx,2},	// 12	거래량	
	{IDS_GH_CODE,		0,	GVAT_HIDDEN,	"1301",	GVFM_CENTER,	GVAT_TOOLTIP|GVAT_DRAGDROP,		2},	// 13	종목코드
	{IDS_GH_NAME,		91,	GVAT_SORTSTR,			"1022",	GVFM_LEFT,	GVAT_TOOLTIP|GVAT_EDIT|GVAT_DRAGDROP,	2},	// 12	종목명
	...
	{IDS_GH_RATE,		60,	GVAT_SORTVAL|GVAT_DRAGMOVE,	"2033",	GVFM_RIGHT,	GVAT_CONDITION|GVAT_SIGNx,				0},	// 16	등락률
	...
	{IDS_GH_ASKSIZE,	70,	GVAT_SORTABS|GVAT_DRAGMOVE,	"3041",	GVFM_RIGHT,	GVAT_COMMA,				1},	// 20
	{IDS_GH_BIDSIZE,	70,	GVAT_SORTABS|GVAT_DRAGMOVE,	"3061",	GVFM_RIGHT,	GVAT_COMMA,				1},	// 21
	...
	{IDS_GH_ASKRATE,	70,	GVAT_SORTVAL|GVAT_DRAGMOVE,	"3104",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITION,		0},	// 24
	{IDS_GH_BIDRATE,	70,	GVAT_SORTVAL|GVAT_DRAGMOVE,	"3109",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITION,		0},	// 25
	...
	{IDS_GH_FOREIGNER,	80,	GVAT_SORTABS|GVAT_DRAGMOVE,	"2399",	GVFM_RIGHT,	GVAT_COMMA,				0},	// 97 외국인
	{IDS_GH_GIGOAN,	80,	GVAT_SORTABS|GVAT_DRAGMOVE,	"2390",	GVFM_RIGHT,	GVAT_COMMA,				0},	// 98 기관
	{IDS_GH_RECOMMDATE,	70,	GVAT_HIDDEN,	"1910",	GVFM_RIGHT,	0,								12},	// 96 체결 이퀄라이저	
	{IDS_GH_RECOMBASICCOST,	100,	GVAT_HIDDEN,	"1911",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	13},	// 96 체결 이퀄라이저	
	{IDS_GH_RECOMSUIKRATE,	60,	GVAT_HIDDEN,	"1912",	GVFM_RIGHT,	GVAT_CONDITION|GVAT_SIGNx,  14},	// 96 체결 이퀄라이저	
	{IDS_GH_RECOMBMJISU,	70,	GVAT_HIDDEN,	"1913",	GVFM_RIGHT,	GVAT_COMMA|GVAT_CONDITIONx,	15},	// 96 체결 이퀄라이저	
	{IDS_GH_RECOMBMRATE,	60,	GVAT_HIDDEN,	"1914",	GVFM_RIGHT,	GVAT_CONDITION|GVAT_SIGNx,	16},	// 96 체결 이퀄라이저	
	{IDS_GH_UPJONGCODE	,	0,	GVAT_HIDDEN,	"1918",	GVFM_RIGHT,	GVAT_COMMA,	17}						// 96 체결 이퀄라이저
...
#define StockService  _T("SONAQ452")  //20200423 잔고조회TR변경
