...
// updateX_20060209
	...
	Acode = "A" + sCode; Jcode = "J" + sCode; Qcode = "J" + sCode;	//2014.11.13 KSJ ETN 추가
...
void CIHCodeCtrl::OnSize(UINT nType, int cx, int cy) 
{
 ...
 //   m_pCombo->MoveWindow(0, editRC.bottom, 0, 0);
// 	m_pCombo->SetWindowPos(&wndTop, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE);
// 	m_pCombo->SetItemHeight(-1, 0);
...
void CIHCodeCtrl::SetFont(CFont* pFont, bool redraw)
{
	...
	m_pEdit->Invalidate(); m_pCombo->Invalidate();
