...
void Cdepth::drawBong(CDC* dc)
{
	...
	tmpS.Format("\r\n[cx_depth] [%d][%d][%d][%d]", rc.left, rc.top, rc.right, rc.bottom);
	...
	tmpS.Format("\r\n[cx_depth] sigaY=[%d] koga=[%d] siga=[%d] jega=[%d]", sigaY, koga, siga, jega);
	OutputDebugString(tmpS);
	...
	dc->Rectangle(CRect(rc.left + 1, rc.top + sigaY, rc.right - 1, rc.top + 10));
	dc->FillSolidRect(CRect(rc.left + 1, rc.top + sigaY, rc.right - 1, rc.top + 10),
		siga < m_curr ? m_clrUp : m_clrDown);
