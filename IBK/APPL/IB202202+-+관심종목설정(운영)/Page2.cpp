...
void CPage2::SetSize()
{
	...
	y = 5;
	//배경색지정
	((CStatic *)GetDlgItem(IDC_COLOR_STATIC))->MoveWindow(x, y, 300, 150);
	((CButton *)GetDlgItem(IDC_RADIO101))->MoveWindow(x+15, y+19, 80, 19);
	((CStatic *)GetDlgItem(IDC_CBTNF101))->MoveWindow(x+90, y+19, 60, 19);
 	((CButton *)GetDlgItem(IDC_RADIO102))->MoveWindow(x+15, y+44, 80, 19);
	((CStatic *)GetDlgItem(IDC_ROW_CNT_STATIC))->MoveWindow(x+90, y+44, 80, 19);
 	((CEdit *)GetDlgItem(IDC_EDITLINE))->MoveWindow(x+172, y+44, 60, 19);
	((CSpinButtonCtrl *)GetDlgItem(IDC_SPIN))->MoveWindow(x+232, y+43, 15, 19);
	((CStatic *)GetDlgItem(IDC_ROW_CNT1_STATIC))->MoveWindow(x+90, y+64, 80, 19);
 	((CStatic *)GetDlgItem(IDC_CBTNF102))->MoveWindow(x+172, y+64, 60, 19);
 	((CStatic *)GetDlgItem(IDC_ROW_CNT2_STATIC))->MoveWindow(x+90, y+84, 80, 19);
 	((CStatic *)GetDlgItem(IDC_CBTNF103))->MoveWindow(x+172, y+84, 60, 19);
	((CStatic *)GetDlgItem(IDC_CBTNREAL_STATIC))->MoveWindow(x+30, y+106, 60, 19);
	((CStatic *)GetDlgItem(IDC_CBTNREAL))->MoveWindow(x+90, y+106, 60, 19);
	((CStatic *)GetDlgItem(IDC_CBTNBOOKMARK_STATIC))->MoveWindow(x+30, y+126, 60, 19);
	((CStatic *)GetDlgItem(IDC_CBTNBOOKMARK))->MoveWindow(x+90, y+126, 60, 19);
