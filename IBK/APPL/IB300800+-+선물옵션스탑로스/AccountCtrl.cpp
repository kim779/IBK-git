...
#define DISPID_ACCOUNTNO	0x00000002
#define	DISPID_ACCOUNTNAME	0x00000006
#define DISPID_ACCOUNTPSWD	0x00000007
/////////////////////////////////////////////////////////////////////////////
// CAccountCtrl
...
long CAccountCtrl::OnMessage(WPARAM wParam, LPARAM lParam)
{
	...
	case eventDLL:
		if (HIBYTE(HIWORD(wParam)) == evOnChange)	// get name
		{
			...
			strData += _T("\t");
			strData += GetPswd();
			return m_pParent->SendMessage(WM_USER + 1, MAKEWPARAM(CHANGEACCOUNT, HIWORD(wParam)), (LONG)(LPCTSTR)strData);
		}
	}
...
CString	CAccountCtrl::GetAccNo()
{
	...
	CComDispatchDriver::GetProperty(pDisp, DISPID_ACCOUNTNO, &var);	
...
CString CAccountCtrl::GetAccName()
{
	...
	CComDispatchDriver::GetProperty(pDisp, DISPID_ACCOUNTNAME, &var);	
	return OLE2T(var.bstrVal);
}
...
CString CAccountCtrl::GetPswd()
{
	...
	CComDispatchDriver::GetProperty(pDisp, DISPID_ACCOUNTPSWD, &var);	
	return OLE2T(var.bstrVal);
}
