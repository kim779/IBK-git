...
struct	_uinfo {
	...
	char	name[80];	// file name			/all   모두 저장....
...
constexpr int sz_uinfo   = sizeof(struct _uinfo);
constexpr int sz_ginfo   = sizeof(struct _ginfo);
constexpr int sz_jinfo   = sizeof(struct _jinfo);
constexpr int sz_updn    = sizeof(struct _updn);
constexpr int sz_updn2    = sizeof(struct _updn2);
constexpr int sz_foldex    = sizeof(struct _foldex);
constexpr int sz_gfoldex    = sizeof(struct _gfoldex);
constexpr int sz_glistex    = sizeof(struct _glistex);
