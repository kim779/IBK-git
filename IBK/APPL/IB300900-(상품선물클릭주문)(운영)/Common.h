...
#define ORDER_INFO_IDX          (0x01)
	...
	#define CONFIG_INI     "%s\\user\\%s\\IB300900.ini"
#else
...
#define MAP_CHART      "IB711500 /S/s/p5/t/d"
#define MAP_JANGO      "IB320100 /S/s/p5/t"
#define MAP_SISECHEG   "IB453100 /S/s/p5/t"
...
typedef enum { CT_NONE=0, CT_GUMRI, CT_MONEY, CT_YUAN } CODE_TYPE;	//2015.11.20 KSJ 위안화 추가
class SiseData {
public:
