========================================================================
		ActiveX Control DLL : CERTIFY
========================================================================

ControlWizard has created this project for your CERTIFY ActiveX Control
...
that make up your CERTIFY ActiveX Control DLL.
...
CertifyCtl.h
	This file contains the declaration of the CCertifyCtrl C++ class.

CertifyCtl.cpp
	This file contains the implementation of the CCertifyCtrl C++ class.

CertifyPpg.h
	This file contains the declaration of the CCertifyPropPage C++ class.

CertifyPpg.cpp
	This file contains the implementation of the CCertifyPropPage C++ class.

CertifyCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCertifyCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Certify.rc.
