...
{
CString slog;
slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull m_ca=[%d]\n", m_ca);
...
slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull 1 err=[%d]\n", GetLastError());
OutputDebugString(slog);
...
slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull 2 err=[%d]\n", GetLastError());
OutputDebugString(slog);
...
slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull 3 err=[%d]\n", GetLastError());
OutputDebugString(slog);
...
slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull 4 err=[%d]\n", GetLastError());
OutputDebugString(slog);


		success = sk_if_CertSetSelectExt(&m_contextNew, CONTEXT_SELECT2, SEARCH_ALLMEDIA);

slog.Format("[AXIS]_  CCertifyCtrl::CertifyFull 5 success=[%d]\n", success);
OutputDebugString(slog);
return 0;
