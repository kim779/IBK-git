#if !defined(AFX_GRIDITEM_H__INCLUDED_)
#define AFX_GRIDITEM_H__INCLUDED_
...
#define	GVAT_SORTSTR		0x00000002	// sort string fixed column attr (header)
#define	GVAT_HIDDEN		0x00000004
#define	GVAT_DRAGMOVE		0x00000008
#define	GVAT_TICKTREND		0x00000010
#define	GVAT_HDRMERGE		0x00000020

#define	GVAT_COMMA		0x00000100	// nonfixed(cell) column attr	(cell)
#define	GVAT_FLOAT1		0x00000200
#define	GVAT_FLOAT2		0x00000400
#define	GVAT_FLOAT4		0x00000800
#define	GVAT_CONDITION		0x00001000
#define	GVAT_CONDITIONx		0x00002000
#define	GVAT_CONTRAST		0x00004000
#define	GVAT_ZEROSUP		0x00008000
#define	GVAT_3DHEAD		0x00010000
#define	GVAT_ONLYROW		0x00020000
...
#endif // !defined(AFX_GRIDITEM_H__INCLUDED_)