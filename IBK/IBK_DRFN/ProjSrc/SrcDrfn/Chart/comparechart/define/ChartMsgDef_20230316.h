...
#define	UMSG_GETTIMESHAREUSEAGE			WM_USER+49	// 시간공유의 사용여부를 받는다...
#define	UMSG_SETTIMESHAREUSEAGE			WM_USER+50	// 시간공유의 사용여부를 보낸다...
...
#define	UMSG_SENDJCODEUNHIGHLIGHTED		WM_USER+59	// 선택표시된 종목을 해제한다.
...
#define UMSG_ADDCODE				WM_USER+94	//비교차트의 종목추가 버튼 클릭
...
#define UMSG_TAB_SELCHANGED					WM_USER+185 //07.01.19  주식,업종,선물 탭 변경
...
const UINT RMSG_KSDLLINFO = ::RegisterWindowMessage(_T("RMSG_KSDLLINFO"));		// TrmCompCharView에게 정보얻기
...
#define DLLTITLENAME			"비교차트"

//분할비교/중첩비교/누적등락률 중첩비교.
#define DIVIDED_COMPARE_CHART			'A'	// 분할비교				차트	2005. 06. 15 add by sy, nam
#define OVERLAPP_COMPARE_CHART			'B'	// 중첩비교				차트	2005. 06. 15 add by sy, nam
#define NUJUK_OVERLAPP_COMPARE_CHARTA	'C'	// 누적등락률 중첩비교(전일종가)	차트	2005. 06. 15 add by sy, nam
#define SUIK_COMPARE_CHART				'D'	// 기간별 수익률 비교	차트	2005. 06. 15 add by sy, nam
#define TOT_NUJUK_COMPARE_CHART			'E'	// 총기간 누적등락 비교	차트	2005. 06. 15 add by sy, nam
#define NUJUK_OVERLAPP_COMPARE_CHARTB	'F'	// 누적등락률 중첩비교(당일시가)	차트	2008. 05. 28
#define NUJUK_OVERLAPP_COMPARE_CHARTC	'G'	// 누적등락률 중첩비교(현재가)	차트	2008. 05. 28

//=========================================================================
//비교차트에 추가하는 지표 명 2005. 07. 27
//=========================================================================
#define JIPYO_STRTITLE_AB		"Graph1"
#define JIPYO_STRTITLE_C		"상대비교차트"
#define JIPYO_STRTITLE_C_NAME	"_상대비교"
//=========================================================================
...
#define ENVINFOFLUCTFILE		"Chartfluct.dat"
...
#define TAB_FAVORITE				"관심"		// 2005. 05. 31 add by sy, nam
#define TAB_STOCK					"주식"		// 2005. 05. 31 add by sy, nam
#define TAB_UPJONG					"업종"		// 2005. 05. 31 add by sy, nam
#define TAB_FUTOPT					"선/옵"		// 2005. 05. 31 add by sy, nam
#define TAB_FOREIGN					"해외"		// 2005. 05. 31 add by sy, nam
#define TAB_ELW						"ELW"		// 2005. 05. 31 add by sy, nam

#define TABNO_FAVORITE				(0)		// 2005. 05. 31 add by sy, nam
#define TABNO_STOCK					(0)		// 2005. 05. 31 add by sy, nam
#define TABNO_UPJONG				(1)		// 2005. 05. 31 add by sy, nam
#define TABNO_FUTOPT				(2)		// 2005. 05. 31 add by sy, nam
#define TABNO_FOREIGN				(3)		// 2005. 05. 31 add by sy, nam
#define TABNO_ELW					(0)		// 2005. 05. 31 add by sy, nam

#define COMPARECHART_TABTOTALCNT	(3)		// 2005. 05. 31 add by sy, nam
...
#ifdef _DEBUG
#define STOCK_TABTOTALCNT		(3)		// 2005. 11. 1 gm0604
#else
#define STOCK_TABTOTALCNT		(3)		// 2005. 05. 16 add by sy, nam 일단 시스템탭은 제외.
#endif
...
#define UPJONG_LENGTH			3		// Eugene에서는 길이가 3
...
#define	CLR_LEFTBAR_BKGRND			RGB(213,213,213)
#define	CLR_INPUTBAR_BKGRND			RGB(213,213,213)
#define	CLR_EXTINPUTBAR_BKGRND		RGB(213,213,213)
#define	CLR_TOOLBAR_BKGRND			RGB(213,213,213)
//@유진추가
