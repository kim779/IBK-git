...
{
	return (COLORREF)DateTime_SetMonthCalColor(m_hWnd, nColIndex, colour);
}

COLORREF CDateTime::GetMonthCalColour(int nColIndex)
{
	return (COLORREF)DateTime_GetMonthCalColor(m_hWnd, nColIndex);
}

void CDateTime::SetMonthCalFont(CFont& font, BOOL bRedraw /*=TRUE*/)
{
...
//BOOL CDateTime::OnDateTimeChangeNotify(NMDATETIMECHANGE *dtmh, LRESULT* pResult) //121128 sspark del
BOOL CDateTime::OnDateTimeChangeNotify(NMHDR * pNmdr, LRESULT* pResult) //121128 sspark add
{
	*pResult = 0;    // docs say we must return 0
	NMDATETIMECHANGE* dtmh = (NMDATETIMECHANGE*)pNmdr; //121128 sspark add
...
//BOOL CDateTime::OnFormat(NMDATETIMEFORMAT* /*lpNMFormat*/, LRESULT* pResult) //121128 sspark del
BOOL CDateTime::OnFormat(NMHDR*, LRESULT* pResult) //121128 sspark add
{
	*pResult = 0;
	return FALSE;
}

//BOOL CDateTime::OnFormatQuery(NMDATETIMEFORMATQUERY* lpDTFormatQuery, LRESULT* pResult) //121128 sspark del
BOOL CDateTime::OnFormatQuery(NMHDR * pNmdr, LRESULT* pResult) //121128 sspark add
{
	NMDATETIMEFORMATQUERY* lpDTFormatQuery = (NMDATETIMEFORMATQUERY*)pNmdr;
	*pResult = 0; lpDTFormatQuery->szMax = CSize(366,16);
	return FALSE;
}

//BOOL CDateTime::OnUserString(NMDATETIMESTRING* /*lpDTstring*/, LRESULT* pResult) //121128 sspark del
BOOL CDateTime::OnUserString(NMHDR *, LRESULT* pResult) //121128 sspark add
{
	*pResult = 0;
	return FALSE;
}